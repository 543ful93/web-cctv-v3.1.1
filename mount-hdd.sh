...
# Penanda di penyimpanan INTERNAL bahwa instalasi ini memakai hardisk eksternal.
# Tanpa ini, server tidak bisa membedakan "tidak pernah pakai hardisk" dari
# "hardisk sedang lepas" — dan akan mengizinkan rekaman memenuhi SD Card.
touch "${DATA_DIR:-/var/lib/webcctv}/.hdd_expected" 2>/dev/null || true
